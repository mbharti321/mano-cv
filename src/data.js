    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "AI / GenAI",
          value:
            "Retrieval-Augmented Generation (RAG), Vector DB, Large Language Models (LLMs), Azure AI Search, LangChain, Agentic AI",
          visible: true,
        },
        {
          id: "sk4",
          label: "Cloud & Data",
          value:
            "Azure: Function App, ServiceBus, EventHub, Storage Account, AppConfig, Managed Identity; AWS Foundations",
          visible: true,
        },
        {
          id: "sk5",
